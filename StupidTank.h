#ifndef GUARD_STUPID_TANK_H
#define  GUARD_STUPID_TANK_H
#include "Enemy.h"
#include "ShooterObject.h"
#include "Bullet.h"
class StupidTank: public Enemy
{
public:
	~StupidTank(){
		ShooterObject::~ShooterObject();
	}
	StupidTank(int health = 1):
		Enemy(){
			// stupid tank specified
			m_width = 32;
			m_height = 32;			
			m_startRow = m_currentRow = 0;
			m_startFrame = 4;
			m_health = health;
